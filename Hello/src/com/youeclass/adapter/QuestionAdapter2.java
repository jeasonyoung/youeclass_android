...
import com.youeclass.BaseActivity;
...
//	private BaseActivity activity;
	...
	public QuestionAdapter2(Context context, QuestionDoExamActivity2 activity,
			ArrayList<ExamQuestion> questionList,String username, String paperid) {
...
//			contentHolder.examAnswerLayout.setVisibility(View.GONE);
		...
		if ("单选题".equals(type) || "多选题".equals(type)) {	//单选题
			...
			if (contentHolder.examOption.getChildCount() > arr.length - 1) {
				for (int j = arr.length - 1; j < contentHolder.examOption
						.getChildCount(); j++) {
...
//					cb.setTextColor(context.getResources().getColor(
//							R.color.black));
...
//					});
			...
			;
			showPics(position, title, imageSavePath, zuheName,
					contentHolder.examImages3, contentHolder.examContent3);
			if (answer != null) {
			...
			contentHolder.submitExamBtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					String txtAnswer = contentHolder.answerEditText.getText()
							.toString();
...
//				}
	...
	public static class ContentViewHolder {
		...
		LinearLayout modeLayout,modeLayout4,examImages3,
				 examImages;
...
//		}
	...
	private class CheckBoxClickListener implements OnClickListener
	{
		...
		public void onClick(View v) {
			...
			activity2.saveChoiceAnswer(group.getValue());
		}
	}
